<template>
  ...
  <table class="table table-striped">
    ...
    <tfoot>
        ...
        <ul class="pagination justify-content-center" v-if="page && page != 1 && page != $store.state.numberOfPages">
          ...
          <li class="page-item">
            <button class="page-link" @click="goToPage(Number($store.state.numberOfPages))">
              {{ $store.state.numberOfPages }}
            </button>
          </li>
        </ul>

        <ul class="pagination justify-content-center" v-if="page == $store.state.numberOfPages">
          <li v-if="page != 2" class="page-item">
            <button class="page-link" @click="goToPage(1)">{{ 1 }}</button>
          </li>
          <li v-if="page != 2" class="page-item">
